...
export default function FollowingList() {
    ...
    const {
        ...
        queryKey: [Paths.FanAttention, Paths.FollowingList, '1'],
    });
                        ...
                        {whetherMutualFollow ? (
                            <>
                                <TouchableRipple
                                    ...
                                    style={[styles.button]}
                                >
                                    <Text style={styles.buttonLabel}>{t('common.interrelation')}</Text>
                                </TouchableRipple>
                                <Pressable
                                    onPress={() => {
                            ...
                            <TouchableRipple
                                ...
                                style={[styles.button]}
                            >
                                <Text style={styles.buttonLabel}>{t('common.unfollow')}</Text>
                            </TouchableRipple>
                        )}
                    </View>
                </View>
    ...
    return (
        <SafeScreen edges={['bottom']} style={[styles.safeScreen, backgrounds.gray1550]}>
            <LegendList

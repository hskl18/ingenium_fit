...
const generateMockCenters = (count: number) => {
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      image: `https://via.placeholder.com/300x200/4A90E2/FFFFFF?text=${center.name.split(' ')[0]}`,
...
const generateMockDoctors = (count: number) => {
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      avatar: `https://via.placeholder.com/150/4A90E2/FFFFFF?text=${doctor.name.split(' ')[1].charAt(0)}`,
  ...
  scienceList: async (data: any): Promise<IResponseData> => {
    ...
    const articles = Array.from({ length: 8 }, (_, i) => {
      ...
      return {
        ...
        image: `https://via.placeholder.com/400x250/4A90E2/FFFFFF?text=${article.category}+Research`,

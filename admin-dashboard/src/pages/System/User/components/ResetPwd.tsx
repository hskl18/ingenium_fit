...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  const checkPassword = (rule: any, value: string) => {
    ...
    return Promise.reject(new Error(intl.formatMessage({
      id: 'system.user.password.mismatch',
  ...
  return (
    ...
    >
      ...
      >
        <p>
          {intl.formatMessage({
            id: 'system.user.reset.prompt',
            defaultMessage: '请输入用户{userName}的新密码！',
          }, { userName: props.values.userName })}
        </p>
        <ProFormText.Password
          name="password"
          label={intl.formatMessage({
            id: 'system.user.login.password',
            defaultMessage: '登录密码',
          })}
          rules={[
            {
              ...
              message: intl.formatMessage({
                id: 'system.user.password.required-not-empty',
                defaultMessage: '登录密码不可为空。',
              }),
            },
          ]}
        />
          ...
          rules={[
            {
              required: true,
              message: intl.formatMessage({
                id: 'system.user.confirm.password.required',
                defaultMessage: '确认密码不可为空',
              }),
            },

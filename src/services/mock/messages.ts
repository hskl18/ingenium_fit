  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      sender: {
        ...
        avatar: `https://via.placeholder.com/50/4A90E2/FFFFFF?text=${message.sender.name.charAt(0)}`,
    ...
    return {
      ...
      data: {
        ...
        sender: {
          ...
          avatar: 'https://via.placeholder.com/50?text=ASN',
        },
  ...
  leaveWordList: async (data: any): Promise<IResponseData> => {
    ...
    const conversations = Array.from({ length: 5 }, (_, i) => ({
      ...
      participant: {
        ...
        avatar: `https://via.placeholder.com/50?text=${['S', 'M', 'J', 'D', 'L'][i]}`,
      ...
      data: {
        ...
        latestMessage: {
          ...
          sender: {
            ...
            avatar: 'https://via.placeholder.com/40?text=NS',
          },

 ...
 * @param fields
 */
const handleAdd = async (fields: API.System.Menu, intl: any) => {
 ...
 * @param fields
 */
const handleUpdate = async (fields: API.System.Menu, intl: any) => {
  const hide = message.loading(intl.formatMessage({
 ...
 * @param selectedRows
 */
const handleRemove = async (selectedRows: API.System.Menu[], intl: any) => {
  const hide = message.loading(intl.formatMessage({
...
const handleRemoveOne = async (selectedRow: API.System.Menu, intl: any) => {
  const hide = message.loading(intl.formatMessage({
    id: 'pages.common.deleting',
    defaultMessage: '正在删除',
  }));
    ...
    <PageContainer>
      ...
      <UpdateForm
        onSubmit={async (values) => {
          let success = false;
          if (values.menuId) {
            success = await handleUpdate({ ...values } as API.System.Menu, intl);
          } else {
            success = await handleAdd({ ...values } as API.System.Menu, intl);
          }
          if (success) {

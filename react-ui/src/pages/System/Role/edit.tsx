    ...
    >
      <ProForm
        ...
        <ProFormDigit
          ...
          placeholder={intl.formatMessage({
            id: 'system.role.role_sort.placeholder',
          ...
          rules={[
            {
              required: true,
              message: intl.formatMessage({
                id: 'system.role.role_sort.required',
                defaultMessage: '请输入显示顺序！',
              }),
            },
          ]}
        ...
        <ProFormRadio.Group
          ...
          placeholder={intl.formatMessage({
            id: 'system.role.status.placeholder',
          ...
          rules={[
            {
              required: true,
              message: intl.formatMessage({
                id: 'system.role.status.required',
                defaultMessage: '请输入角色状态！',
              }),
            },
          ]}
        ...
        <ProFormTextArea
          ...
          placeholder={intl.formatMessage({
            id: 'system.role.remark.placeholder',
          ...
          rules={[
            {
              required: false,
              message: intl.formatMessage({
                id: 'system.role.remark.required',
                defaultMessage: '请输入备注！',
              }),
            },
          ]}

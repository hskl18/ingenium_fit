    ...
    >
        ...
        <ProFormDigit
          ...
          placeholder={intl.formatMessage({
            id: 'system.dict.dict_id.placeholder',
          ...
          rules={[
            {
              ...
              message: intl.formatMessage({
                id: 'system.dict.dict_id.required',
                defaultMessage: '请输入字典主键！',
              }),
            },
          ]}
        ...
        <ProFormText
          ...
          placeholder={intl.formatMessage({
            id: 'system.dict.dict_name.placeholder',
          ...
          rules={[
            {
              required: false,
              message: intl.formatMessage({
                id: 'system.dict.dict_name.required',
                defaultMessage: '请输入字典名称！',
              }),
            },
          ]}
        ...
        <ProFormText
          ...
          placeholder={intl.formatMessage({
            id: 'system.dict.dict_type.placeholder',
          ...
          rules={[
            {
              required: false,
              message: intl.formatMessage({
                id: 'system.dict.dict_type.required',
                defaultMessage: '请输入字典类型！',
              }),
            },
          ]}
        ...
        <ProFormRadio.Group
          ...
          initialValue={'0'}
          placeholder={intl.formatMessage({
            id: 'system.dict.status.placeholder',
          ...
          rules={[
            {
              required: false,
              message: intl.formatMessage({
                id: 'system.dict.status.required',
                defaultMessage: '请输入状态！',
              }),
            },
          ]}
        ...
        <ProFormTextArea
          ...
          placeholder={intl.formatMessage({
            id: 'system.dict.remark.placeholder',
          ...
          rules={[
            {
              required: false,
              message: intl.formatMessage({
                id: 'system.dict.remark.required',
                defaultMessage: '请输入备注！',
              }),
            },
          ]}
